...
# We define absolute paths for our UI folders. This is the most robust method.
...
# We initialize Flask and tell it exactly where to find the HTML and the CSS/JS.
app = Flask(__name__, template_folder=_template_folder, static_folder=_static_folder)


def create_default_skeleton():
    # ... (The rest of this function is unchanged, content omitted for brevity)
